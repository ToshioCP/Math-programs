module MathPrograms
  ...
  # They are the coefficients a and b.
  # The instance method 'solve' returns a pair of the solution [x, y].
  # It uses euclidian algorithm.
  class Axby1
    attr_accessor :a, :b
    # Two arguments a and b are the constants of ax+by=1.
    # They must be coprime.
    # Otherwise the coefficients a and b, that are @a and @b in the instance, are set to be nil.
    # Then the methods 'solve' returns nil.
